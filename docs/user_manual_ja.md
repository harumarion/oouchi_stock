...
- 画面下部のメニューバーから各機能に移動できます。左から「買い物リスト」「在庫一覧」「買い物予報」「商品追加」「セール情報」の順に並んでいます。
...
- 在庫一覧やセール情報画面の「買い物リストに追加」ボタンを押すと、このリストに追加されます。
- カードを右にスワイプすると削除できます。削除前には確認ダイアログが表示されます。
- 表示されたカードには買い物リストに追加ボタンはありません。
