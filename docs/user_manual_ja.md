...
- 在庫カードをタップすると詳細画面に移動します。カードを右にスワイプすると削除確認ダイアログが表示されます。
...
- カテゴリごとに登録したセール情報をカード形式で一覧表示します。カード左上に「品種/商品名」を一行で表示し、期限や価格情報が続きます。カードをタップすると詳細画面が開きます。
...
- 各カテゴリをタップすると編集画面が開き、右スワイプで削除できます。
