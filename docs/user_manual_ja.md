...
- 検索バーは SearchAnchor に変更され、虫眼鏡アイコンから検索できるようになりました。商品名だけでなくカテゴリ名や品種名でも検索できます。
...
- 期限が近いセールは赤字で表示されます。
- 上部の SearchAnchor から虫眼鏡アイコンでセール情報を検索できます。
...
- 画面上部の検索バーから手動で商品名を追加できます。虫眼鏡アイコンは表示されず、検索語を直接入力します。入力中は在庫商品の候補が表示されます。
...
## 買い物予報画面
- 各カテゴリごとに予報リストがタブ表示されます。
- 上部の SearchAnchor から虫眼鏡アイコンで商品を検索できます。
